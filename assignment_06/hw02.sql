...
DROP TEMPORARY TABLE IF EXISTS table_rolling_lookup;

CREATE TEMPORARY TABLE table_rolling_lookup AS
...
CREATE UNIQUE INDEX rolling_lookup_date_game_batter_id_idx ON table_rolling_lookup (game_id, batter,
local_date);
CREATE UNIQUE INDEX rolling_lookup_game_batter_id_idx ON table_rolling_lookup (game_id, batter);
CREATE INDEX rolling_lookup_game_id_idx ON table_rolling_lookup (game_id);
